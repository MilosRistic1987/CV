...
const ProjectCard = ({ cardData }) => {
  ...
  return (
    <div className="projectCard">
      <ProjectPhotoSlider
        photoSliderOpen={photoSliderOpen}
        setPhotoSliderOpen={setPhotoSliderOpen}
        photos={photoUrl}
      />
      <div className="projectPhoto">
        <img
          src={require("../utilites/projectsImg" + first)}
          alt="background"
        />
        <div className="overlay">
          <div
            onClick={() => handleSlider()}
            title="Click to see Image Gallery for this project"
          >
            <h1>See more</h1>
          </div>
        </div>
      ...
      <div>
        {category === "Adobe" ? null : (
          <a
            ...
            title="Visit GitHub to clone repositories"
          >
            Go to gitHub
          </a>
        )}
