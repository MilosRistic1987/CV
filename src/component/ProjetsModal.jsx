  ...
  useEffect(() => {
    const filteredProjectsData =
      selectedProjetcsCategory !== "All"
        ...
        : projectsData;
    {isMobile ? setMobileIndexes({ startMobileIndex: 0, endMobileIndex: 1 }) : setIndexes({ startIndex: 0, endIndex: 3 })};
    ...
    <div className={modalClassName}>
      ...
      <div className="projetsList">
        {isMobile
          ? projectsCategory
              .slice(
                mobileIndexes.startMobileIndex,
                mobileIndexes.endMobileIndex
              )
              .map((el) => <ProjectCard cardData={el} key={el.id} />)
          : projectsCategory
      ...
      <div className="pagginationWrapp">
        <div>
          <button
            disabled={
              isMobile
                ? mobileIndexes.startMobileIndex === 0
          ...
          <button
            disabled={
              isMobile
                ? projectsCategory.length <= mobileIndexes.endMobileIndex
                : projectsCategory.length <= indexes.endIndex
            }
